        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SVAT_Registration_No; CompanyInfo."SVAT Registration No.")
                    {
                    }
                    column(Payment_Method; "Purchase Header"."Payment Method Code")
                    {
                    }
                    ...
                    column(Quote_No; "Purchase Header"."Quote No.")
                    {
                    }
