report 50014 "Commercial Invoice"
{
    //DefaultLayout = RDLC;
    RDLCLayout = './Reports/Commercial Invoice.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(Cust_Order_No; "Sales Header"."Customer Order Number.")
                    {
                    }
                    column(Bank_Code; "Sales Header"."Bank Code")
                    {
                    }
                    column(Bank_Acc_No; BankCard."Bank Account No.")
                    {
                    }
                    ...
                    column(Bank_Phone_No; BankCard."Phone No.")
                    {
                    }
                    column(Vessel; "Sales Header".Vessel)
                    {
                    }
                    column(Destination; "Sales Header".Destination)
                    {
                    }
                    column(Flight_No; "Sales Header"."Flight No")
                    {
                    }
                ...
                begin
                    ...
                    //SalesPostPrepmt.BuildInvLineBuffer2("Sales Header", PrepmtSalesLine, 0, PrepmtInvBuf);    //MR
