report 50016 "Order - Foreign"
{
    //DefaultLayout = RDLC;
    RDLCLayout = './Reports/Order - Foreign.rdl';
    Caption = 'Order';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(PurchaseHeaderShipmentMethodCode; "Purchase Header"."Shipment Method Code")
                    {
                    }
                    column(CompanyInfoSVATRegistrationNo; CompanyInfo."SVAT Registration No.")
                    {
                    }
                    column(CompanyInfoForeignPOPhoneNo; CompanyInfo."Foreign PO Phone No")
                    {
                    }
                    ...
                    column(PurchaseHeaderPaymentMethodCode; "Purchase Header"."Payment Method Code")
                    {
                    }
                    ...
                    column(PartShipment; "Purchase Header"."Part Shipment")
                    {
                    }
                    column(DeliveryDetails; "Purchase Header"."Delivery Details")
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(txtDescriptionLine; txtDescriptionLine)
                        {
                        }
                        ...
                        begin
                            ...
                            TotalSubTotal := 0.0;
                            TotalAmount := 0.0;
                            TotalInvoiceDiscountAmount := 0.0;
                            icount1 := 0.0;
                            txtExtendedLine := '';
                            ...
                            txtDescriptionLine := "Purchase Line".Description + ' ' + "Purchase Line"."Description 2";

                            recExtendedTextLine.RESET;
                            recExtendedTextLine.SETRANGE(recExtendedTextLine."No.", "Purchase Line"."No.");
                            //MESSAGE('recExtendedTextLine.COUNT = '+FORMAT(recExtendedTextLine.COUNT));
                            REPEAT
            ...
            begin
                ...
                //==== SW-Transportmethod=====
                rectranme.RESET;
                rectranme.SETRANGE(rectranme.Code, "Purchase Header"."Transport Method");

                IF rectranme.FINDFIRST THEN BEGIN
                    transportmethod := rectranme.Description;
                END;
                //===================//
            end;
        }
    ...
    var
        ...
        rectranme: Record "Transport Method";
        transportmethod: Text[30];
        icount1: Integer;
