report 50011 "Inventory Valuation - ICW"
{
    // SSJ-JIT Changed Request - based on item categories 07/03
    //DefaultLayout = RDLC;
    RDLCLayout = './Reports/Inventory Valuation - ICW.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            RequestFilterFields = "No.", "Inventory Posting Group", "Statistics Group", "Item Category Code";
            ...
            { }
            column(ItemCategoryFilter; GETFILTER("Item Category Code"))
            { }
