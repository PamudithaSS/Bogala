report 50013 "Packing Instruction"
{
    //DefaultLayout = RDLC;
    RDLCLayout = './Reports/Packing Instruction.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(SalesHeaderPackingComm; "Sales Line"."Packing Comm.")
                    {
                    }
                    column(SalesHeaderShippingMarks; "Sales Header"."Shipping Marks")
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(Packing; "Sales Line"."Packing Comm.")
                        {
                        }
